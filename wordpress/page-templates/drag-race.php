...
.lnk:hover{opacity:.65!important}
.pill{transition:background-color .2s ease}
...
(function(){
  ...
  var ENTRIES = { name:"entry.993766149", email:"entry.360654526", company:"entry.676895337", role:"entry.70834795", use:"entry.1822215419", ip:"entry.1655459558" };
  var visitorIP = "";
  fetch('https://api.ipify.org?format=json').then(function(r){ return r.json(); }).then(function(d){ visitorIP = d.ip || ""; }).catch(function(){});
  ...
  $('apiForm').addEventListener('submit', function(e){
    ...
    if(visitorIP) body.append(ENTRIES.ip,visitorIP);
