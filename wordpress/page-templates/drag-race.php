...
<header style="position:sticky;top:0;z-index:50;background:color-mix(in srgb,var(--bg) 86%,transparent);backdrop-filter:saturate(120%) blur(8px);-webkit-backdrop-filter:saturate(120%) blur(8px);border-bottom:1px solid var(--line-soft)">
  <div style="max-width:1200px;margin-inline:auto;padding-inline:clamp(1.25rem,5vw,5rem);display:flex;align-items:center;justify-content:space-between;height:72px">
    ...
    <nav style="display:flex;gap:2rem;align-items:center">
      ...
      <a class="lnk" href="https://haleswx.com/#about" style="font-family:var(--font-sans);font-size:0.95rem;text-decoration:none;color:var(--ink);opacity:.82">About</a>
      <a class="lnk" href="https://haleswx.com/#advantage" style="font-family:var(--font-sans);font-size:0.95rem;text-decoration:none;color:var(--ink);opacity:.82">Advantage</a>
      <a class="lnk" href="https://haleswx.com/#use-cases" style="font-family:var(--font-sans);font-size:0.95rem;text-decoration:none;color:var(--ink);opacity:.82">Applications</a>
      <a class="lnk" href="https://haleswx.com/#lab" style="font-family:var(--font-sans);font-size:0.95rem;text-decoration:none;color:var(--ink);opacity:.82">Lab</a>
      <a class="lnk" href="https://haleswx.com/drag-race/" aria-current="page" style="font-family:var(--font-sans);font-size:0.95rem;text-decoration:none;color:var(--ink);opacity:1;font-weight:600;border-bottom:2px solid var(--ink);padding-bottom:2px">Space</a>
      </div>
